        ...
        <div className="wrap">
          <div className="contact-grid">
            <div className="reveal">
              <div className="cbtns">
                <a className="cbtn wa" href="https://wa.me/6580892716?text=Halo%20Forkumi!%20Saya%20tertarik%20dengan%20layanan%20desain%20langganan." target="_blank" rel="noopener"><span className="ci"><span className="icon-dot" aria-hidden="true" /></span><div><b>WhatsApp</b><small>+65 8089 2716</small></div></a>
                <a className="cbtn mail" href="mailto:linkforkumi@gmail.com"><span className="ci"><span className="icon-dot" aria-hidden="true" /></span><div><b>Email</b><small>linkforkumi@gmail.com</small></div></a>
                <a className="cbtn ig" href="https://www.instagram.com/forkumi.design/" target="_blank" rel="noopener"><span className="ci"><span className="icon-dot" aria-hidden="true" /></span><div><b>Instagram</b><small>@forkumi.design</small></div></a>
                <a className="cbtn ph" href="tel:+6580892716"><span className="ci"><span className="icon-dot" aria-hidden="true" /></span><div><b>+65 8089 2716</b><small>Singapore</small></div></a>
                <div className="cbtn" style={{ cursor: "default" }}><span className="ci" style={{ background: "var(--gold)" }}><span className="icon-dot" aria-hidden="true" /></span><div><b data-i="hoursH"></b><small data-i="hours"></small></div></div>
              </div>
            </div>
