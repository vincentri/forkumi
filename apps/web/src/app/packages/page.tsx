...
export default function PackagesPage(): ReactElement {
  return (
    <>
      ...
      <section className="cta-sec">
        ...
        <div className="wrap">
          ...
          <div className="cta reveal d2">
            <a className="btn primary" href="https://wa.me/6580892716?text=Halo%20Forkumi!%20Saya%20mau%20mulai%20langganan%20desain." target="_blank" rel="noopener"><span data-i="ctaBtn"></span> <span className="ar">➔</span></a>
