...
export default function Footer({ siteName = "Quantyx", logo }: { siteName?: string; logo?: string }) {
        ...
        <div className="flex items-center gap-3">
          {socials.map((social) => (
            <a
              key={social.name}
              href={social.href}
              className="group flex size-9 items-center justify-center rounded-full border border-slate-200 dark:border-slate-800 text-slate-400 dark:text-slate-600 transition-all hover:border-sky-300 hover:text-sky-500 hover:shadow-sm hover:shadow-sky-200 dark:hover:shadow-sky-900"
